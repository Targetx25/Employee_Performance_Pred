...
try:
    # Use the correct model filename from the training script
...
# This is crucial for correctly preparing the prediction data.
# These columns are generated by pd.get_dummies() in the training script.
MODEL_COLUMNS = [
